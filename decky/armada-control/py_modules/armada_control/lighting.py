...
def _default_state(supported):
    return {"supported": supported, "mode": DEFAULT_MODE, "color": DEFAULT_COLOR, "screenLink": DEFAULT_SCREEN_LINK, "params": {}}
...
def stick_led_state():
    ...
    try:
        ...
        mode, color, screen_link, params = DEFAULT_MODE, DEFAULT_COLOR, DEFAULT_SCREEN_LINK, {}
        for line in out.splitlines():
            ...
            if key == "mode" and value in STICK_LED_MODES:
                ...
                try:
                    ...
                    pass
        return {"supported": True, "mode": mode, "color": color, "screenLink": screen_link, "params": params}
    return {
        "supported": True,
